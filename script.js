...
function initThresholdModel() {
    ...
    const nodeCount = width < 600 ? 30 : 50;
    ...
    function initNodes() {
        ...
        for (let i = 0; i < nodeCount; i++) {
            const x = padding + Math.random() * (validWidth - 2 * padding);
            const y = padding + Math.random() * (validHeight - 2 * padding);

...
The project includes a comprehensive [exploration page](exploration.html) that addresses:

- **Parameter Operationalization** - How to measure r, K, β in the real world
- **Dynamic Resistance** - γ as a function of A
- **Phase Transitions** - Models as states of a larger meta-system
- **Inner vs. Outer Work** - Horizontal spread vs. vertical depth
- **Continuous Spectrum** - Beyond binary awakening
- **Historical Case Studies** - Mindfulness movement, Axial Age
- **Testable Predictions** - Moving from metaphor to science
